...
.stNumberInput input:focus{{border-color:{COLOR_ACCENT}!important;box-shadow:0 0 0 1px {COLOR_ACCENT}40!important}}
.stNumberInput label{{
...
[data-testid="stTabsList"]{{
    ...
    border-radius:0!important;gap:0!important;padding:0 6px!important;margin-bottom:4px!important;
}}
...
[data-testid="stPills"] button:hover{{color:{COLOR_TEXT}!important;border-color:{COLOR_ACCENT}80!important}}
[data-testid="stPills"] button[aria-checked="true"]{{
    background:{COLOR_ACCENT}18!important;border-color:{COLOR_ACCENT}70!important;color:{COLOR_TEXT}!important;
}}
...
<div style='background:{COLOR_PANEL};border-bottom:1px solid #2a2e39;
  ...
  <div style='display:flex;align-items:center;gap:10px;flex-shrink:0;'>
    <div style='width:30px;height:30px;border-radius:5px;
         ...
         box-shadow:0 0 14px {COLOR_ACCENT}55;'>🛢</div>
    <div>
      <div style='color:{COLOR_TEXT};font-family:"IBM Plex Mono",monospace;font-size:12px;font-weight:600;letter-spacing:.5px;'>{APP_TITLE}</div>
      <div style='color:#787b86;font-family:"IBM Plex Mono",monospace;font-size:8px;margin-top:1px;'>{APP_SUBTITLE} · {VERSION}</div>
    </div>
  </div>
  ...
  <div style='flex-shrink:0;text-align:right;'>
    <div style='display:flex;align-items:center;gap:5px;justify-content:flex-end;'>
      <div style='width:7px;height:7px;border-radius:50%;background:{COLOR_UP};
           box-shadow:0 0 8px {COLOR_UP};animation:livePulse 2s ease-in-out infinite;'></div>
    ...
    <div style='color:#4a4e5a;font-family:"IBM Plex Mono",monospace;font-size:8px;margin-top:2px;'>↻ {REFRESH_SECONDS}s</div>
  </div>
</div>
""")
...
with tab_chart:
    ...
    with chart_col:
        ...
        st.html(f"""
        <div style='font-family:"IBM Plex Mono",monospace;font-size:10px;color:#787b86;
...
with tab_mirofish:
    st.html(f"""
    <div style='display:flex;align-items:center;gap:8px;padding:5px 4px 7px;'>
